        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-9" id="checkout">
                    ...
                    <div class="box">
                        <form method="post" action="<?php echo base_url().'welcome/checkout4'?>">
                            ...
                            <div class="box-footer">
                                <div class="pull-left">
                                    <a href="<?php echo base_url().'welcome/checkout2'?>" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back to Delivery method</a>
                                </div>
                                <div class="pull-right">
