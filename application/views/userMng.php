...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="form-group">
                                                <label for="CustID" class="col-sm-6 control-label">User ID</label>
                                                <div class="col-sm-7">
                                            ...
                                            <div class="form-group">
                                                <label for="CustCode" class="col-sm-6 control-label">Title</label>
                                            ...
                                            <div class="form-group">
                                                <label for="cusName" class="col-sm-6 control-label">First Name</label>
                                                <div class="col-sm-7">
                                            ...
                                            <div class="form-group">
                                                <label for="CustAddress" class="col-sm-6 control-label">Address Line 2</label>
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" id="CustAddress" name="Address2" required>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label for="CustContact" class="col-sm-6 control-label">Contact Details</label>
                                                <div class="col-sm-7">
            ...
            <form method="post" action="<?php echo base_url()?>index.php/Users/deleteUser">
                        ...
                        <div class="box-body table-responsive">
                            <table id='customer_table' class="table table-striped table-bordered col-lg-12">
                                ...
                                <tr>
                                    ...
                                    <th><a href="#" data-sort="CustomerID">User ID</a></th>
                                    <th><a href="#" data-sort="CustomerCode">User Title</a></th>
                                    <th><a href="#" data-sort="CustomerName"> User Name</a></th>
                                    <th><a href="#" data-sort="CustomerAddress">User Address</a></th>
                                    <th><a href="#" data-sort="CustomerContact">User Contact</a></th>
                                    <th><a href="#" data-sort="CustomerRegDate">User Enrolled Date</a></th>
                                ...
                                foreach ($userData as $row){
                                    ...
                                    ?><tr>
                                    <td><input name="checkbox[]" class="case" type="checkbox" value=<?php echo $row->user_id;?>></td>
